...
RSpec.describe 'Suites', type: :request do
  ...
  it '400s with non integer offset' do
    get '/three3/suites', params: { offset: 'hello' }
    expect(response).to have_http_status(400)
  end

  it '400s with non integer limit' do
    get '/three3/suites', params: { limit: 'world' }
    expect(response).to have_http_status(400)
  end

  it '400s with negative offset' do
    get '/three3/suites', params: { offset: '-7' }
    expect(response).to have_http_status(400)
  end

  it '400s with negative limit' do
    get '/three3/suites', params: { limit: -5 }
    expect(response).to have_http_status(400)
  end
  ...
  describe 'when it has 3 suites' do
    ...
    it 'will obey an offset' do
      get '/three3/suites', params: { offset: 1 }
      expect_body(
        offset: 1,
        suites: [
          { name: 'my suite2' },
    ...
    it 'will obey a limit' do
      get '/three3/suites', params: { limit: 2 }
      expect_body(
        offset: 0,
        suites: [
          { name: 'my suite1' },
    ...
    it 'will obey a limit and offset' do
      get '/three3/suites', params: { limit: 1, offset: 1 }
      expect_body(
        offset: 1,
        suites: [
          { name: 'my suite2' }
  ...
  describe 'modifying' do
    ...
    it 'can create a suite' do
      post '/three3/suites', params: { name: 'created suite' }
